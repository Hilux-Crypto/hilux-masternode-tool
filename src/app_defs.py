...
APP_NAME_SHORT = 'HiluxMasternodeTool'
APP_NAME_LONG = 'Hilux Masternode Tool'
APP_DATA_DIR_NAME = '.dmt'
PROJECT_URL = 'https://github.com/Bertrand256/hilux-masternode-tool'
FEE_DUFF_PER_BYTE = 1
MIN_TX_FEE = 1000
...
__KNOWN_LOGGERS = [
    ...
    KnownLoggerType(name='dmt.hiluxd_intf', external=False),
