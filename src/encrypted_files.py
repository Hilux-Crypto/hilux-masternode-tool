...
from hilux_utils import num_to_varint, read_varint_from_file, bip32_path_n_to_string
...
def prepare_hw_encryption_attrs(hw_session: HwSessionInfo, label: str) -> \
    ...
    if hw_session.hw_type in (HWType.trezor, HWType.keepkey):
        ...
        sig = hw_sign_message(hw_session, 'Hilux', bip32_path_str, key_bin.hex(), display_label=display_label)
        adr_pk = get_address_and_pubkey(hw_session, 'Hilux', bip32_path_str)
                    ...
                    if hw_type:
                        ...
                        while True:
                            ...
                            if hw_session.hw_type in (HWType.trezor, HWType.keepkey):
                                ...
                                bip32_path_str = bip32_path_n_to_string(bip32_path_n)
                                sig = hw_sign_message(hw_session, 'Hilux', bip32_path_str, encrypted_key_bin.hex(),
