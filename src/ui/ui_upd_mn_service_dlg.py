...
class Ui_UpdMnServiceDlg(object):
    ...
    def retranslateUi(self, UpdMnServiceDlg):
        ...
        self.label.setText(_translate("UpdMnServiceDlg", "The transaction type associated with this action (ProUpServTx) is used to update information relating to the operator (<a href=\"https://docs.hilux.org/en/stable/masternodes/maintenance.html#proupservtx\">details</a>)."))
