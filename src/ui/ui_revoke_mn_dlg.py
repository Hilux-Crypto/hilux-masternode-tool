...
class Ui_RevokeMnDlg(object):
    ...
    def retranslateUi(self, RevokeMnDlg):
        ...
        self.lblDescription.setText(_translate("RevokeMnDlg", "The transaction type associated with this action (ProUpRevTx) is used by the operator to terminate service or signal the owner that a new BLS key is required (<a href=\"https://docs.hilux.org/en/stable/masternodes/maintenance.html#prouprevtx\">details</a>)."))
