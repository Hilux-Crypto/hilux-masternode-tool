...
class Ui_UpdMnRegistrarDlg(object):
    ...
    def retranslateUi(self, UpdMnRegistrarDlg):
        ...
        self.lblDescription.setText(_translate("UpdMnRegistrarDlg", "The transaction type associated with this action (ProUpRegTx) is used to update information relating to the owner (<a href=\"https://docs.hilux.org/en/stable/masternodes/maintenance.html#proupregtx\">details</a>)."))
