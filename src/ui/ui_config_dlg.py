...
class Ui_ConfigDlg(object):
    def setupUi(self, ConfigDlg):
        ...
        self.tabHiluxd = QtWidgets.QWidget()
        self.tabHiluxd.setObjectName("tabHiluxd")
        self.verticalLayout_3 = QtWidgets.QVBoxLayout(self.tabHiluxd)
        self.verticalLayout_3.setContentsMargins(3, 3, 3, 3)
        self.verticalLayout_3.setSpacing(3)
        self.verticalLayout_3.setObjectName("verticalLayout_3")
        self.horizontalLayout_3 = QtWidgets.QHBoxLayout()
        self.horizontalLayout_3.setObjectName("horizontalLayout_3")
        self.label_2 = QtWidgets.QLabel(self.tabHiluxd)
        self.label_2.setObjectName("label_2")
        self.horizontalLayout_3.addWidget(self.label_2)
        self.cboHiluxNetwork = QtWidgets.QComboBox(self.tabHiluxd)
        self.cboHiluxNetwork.setObjectName("cboHiluxNetwork")
        self.cboHiluxNetwork.addItem("")
        self.cboHiluxNetwork.addItem("")
        self.horizontalLayout_3.addWidget(self.cboHiluxNetwork)
        spacerItem = QtWidgets.QSpacerItem(40, 20, QtWidgets.QSizePolicy.Expanding, QtWidgets.QSizePolicy.Minimum)
        self.horizontalLayout_3.addItem(spacerItem)
        self.verticalLayout_3.addLayout(self.horizontalLayout_3)
        self.frame_2 = QtWidgets.QFrame(self.tabHiluxd)
        ...
        self.tabWidget.addTab(self.tabHiluxd, "")
        ...
        self.chbShowHiluxFIATValue = QtWidgets.QCheckBox(self.tabMisc)
        self.chbShowHiluxFIATValue.setObjectName("chbShowHiluxFIATValue")
        self.verticalLayout_2.addWidget(self.chbShowHiluxFIATValue)
    ...
    def retranslateUi(self, ConfigDlg):
        ...
        self.label_2.setText(_translate("ConfigDlg", "Hilux network:"))
        self.cboHiluxNetwork.setItemText(0, _translate("ConfigDlg", "MAINNET"))
        self.cboHiluxNetwork.setItemText(1, _translate("ConfigDlg", "TESTNET"))
        ...
        self.tabWidget.setTabText(self.tabWidget.indexOf(self.tabHiluxd), _translate("ConfigDlg", "Hilux network"))
        ...
        self.chbShowHiluxFIATValue.setText(_translate("ConfigDlg", "Show DASH value in FIAT"))
        ...
        self.chbDownloadProposalExternalData.setText(_translate("ConfigDlg", "Download external proposal attributes (HiluxCentral.org)"))
