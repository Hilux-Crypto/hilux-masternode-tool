...
2. On the running Linux system, download the latest [Hilux Masternode Tool archived binary](https://github.com/Bertrand256/hilux-masternode-tool/releases) (.tar.gz) from the project page, or copy the file to the system in some other way.
