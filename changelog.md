...
addresses referring to HiluxCentral, a recent common mistake made by proposal owners.
...
for the operator and Hilux addresses for the owner and voting.
- Main window: the possibility of displaying private keys in the form 
of: Hilux address, public key and public key hash (for diagnostics).
...
in the `protx prepare` call (added in Hilux Core rc11).
...
**Added**
- Support for Hilux v13 - Deterministic Masternode List (protocol 70213)
...
**Added**
- Hilux daemon v12.3 support (protocol 70209/70210)
...
- Moved to the official Trezor Insight API for Hilux (https://hilux-bitcore1.trezor.io/api/).
...
- The connection was incorrectly shown as successful for proxy connections when nginx was running, but the Hilux daemon was not.
...
- Changed the domain for "public" nodes to something more relevant: hilux-masternode-tool.org.
- Changed the TCP port number for *alice* and *luna* "public" RPC nodes to 443 - the official HTTPS port.
- Added a new "public" RPC node: suzy.hilux-masternode-tool.org:443.
